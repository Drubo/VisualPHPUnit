...
$config = array(
    ...
    'optional_bootstraps' => array(
      '1' => array(
        'file' => "{$root}/browser_settings/firefox/browser_settings.php",
        'name' => 'Firefox'
      ),
      '2' => array(
        'file' => "{$root}/browser_settings/chrome/browser_settings.php",
        'name' => 'Chrome'
      ),
      '3' => array(
        'file' => "{$root}/browser_settings/internet_explorer/browser_settings.php",
